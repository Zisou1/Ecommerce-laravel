            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link font-weight-bold" href="/">Search products</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/order/show">Your orders</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <ul class="navbar-nav ms-auto">
                        <script src="https://cdn.lordicon.com/bhenfmcm.js"></script>
                            ...
                            <span class="badge badge-pill badge-primary wishlist-count">{{ $wishlistCount }}</span>
                        </a>
                        <script src="https://cdn.lordicon.com/bhenfmcm.js"></script>
                            <a href="{{url('/carts')}}">
                            <lord-icon
                            ...
                            <span class="badge badge-pill badge-primary wishlist-count">{{$cartCount}}</span>
                        </a>
